...
import { LogoutComponent } from './pages/game/logout/logout.component';
...
const routes: Routes = [
  ...
  { path: 'game/logout', component: LogoutComponent },
  ...
  {
    path: 'admin/world/:id_world/scenarios',
    component: ScenariosComponent,
    canActivate: [AuthGuard],
  },
  {
    path: 'admin/world/:id_world/scenario/:id_scenario',
  ...
  {
    path: 'admin/resources/backgrounds',
    component: BackgroundsComponent,
    canActivate: [AuthGuard],
  },
  {
    path: 'admin/resources/backgrounds/categories',
    component: BackgroundCategoriesComponent,
    canActivate: [AuthGuard],
  },
  {
    path: 'admin/resources/characters',
    component: CharactersComponent,
    canActivate: [AuthGuard],
  },
  {
    path: 'admin/resources/scenario-objects',
    component: ScenarioObjectsComponent,
    canActivate: [AuthGuard],
  },
  {
    path: 'admin/resources/items',
