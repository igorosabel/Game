...
export class ApiService {
  ...
  getUnlockedWorlds(id: number): Observable<WorldResult> {
    return this.http.post<WorldResult>(this.url + 'api/get-unlocked-worlds', {
      id,
    });
  }
  ...
  hitEnemy(idGame: number, idScenarioData: number): Observable<StatusResult> {
    return this.http.post<StatusResult>(this.url + 'api/hit-enemy', {
      idGame,
      idScenarioData,
    });
  }
  ...
  deleteWorld(id: number): Observable<StatusResult> {
    return this.http.post<StatusResult>(this.url + 'admin/delete-world', {
      id,
    });
  }

  getScenarios(id: number): Observable<ScenarioResult> {
    return this.http.post<ScenarioResult>(this.url + 'admin/scenario-list', {
      id,
    });
  }
  ...
  deleteScenario(id: number): Observable<StatusResult> {
    return this.http.post<StatusResult>(this.url + 'admin/delete-scenario', {
      id,
    });
  }

  getScenario(id: number): Observable<ScenarioDataResult> {
    return this.http.post<ScenarioDataResult>(this.url + 'admin/get-scenario', {
      id,
    });
  }
  ...
  generateMap(id: number): Observable<StatusResult> {
    return this.http.post<StatusResult>(this.url + 'admin/generate-map', {
      id,
    });
  }
  ...
  deleteItem(id: number): Observable<StatusMessageResult> {
    return this.http.post<StatusMessageResult>(this.url + 'admin/delete-item', {
      id,
    });
  }
